    ...
    tests: {
      numeric: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          equal($('label[for=edit-numeric].error:visible').length, 1, Drupal.t('Error label found for "Numeric"'));
          ...
          // Check for the "Numeric" error.
          equal($('label[for=edit-numeric].error:visible').length, 0, Drupal.t('Error label not found for "Numeric"'));
        }
      },
      rangeLength: function ($, Drupal, window, document, undefined) {
        return function () {
          ...
          equal($('label[for=edit-length-range].error:visible').length, 1, Drupal.t('Error label found for "Range length"'));
          ...
          // Check for the "Range length" error.
          equal($('label[for=edit-length-range].error:visible').length, 0, Drupal.t('Error label not found for "Range length"'));
        }
      },
      limitedChars: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          equal($('label[for=edit-chars].error:visible').length, 1, Drupal.t('Error label found for "Chars"'));
          ...
          // Check for the "Chars" error.
          equal($('label[for=edit-chars].error:visible').length, 0, Drupal.t('Error label not found for "Chars"'));
        }
      },
      email: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-email].error:visible').length, 1, Drupal.t('Error label found for "Email"'));
          ...
          // Check for the error.
          equal($('label[for=edit-email].error:visible').length, 0, Drupal.t('Error label not found for "Email"'));
        }
      },
      url: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-url].error:visible').length, 1, Drupal.t('Error label found for "URL"'));
          ...
          // Check for the error.
          equal($('label[for=edit-url].error:visible').length, 0, Drupal.t('Error label not found for "URL"'));
        }
      },
      ipv4: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-ipv4].error:visible').length, 1, Drupal.t('Error label found for "IPv4"'));
          ...
          // Check for the error.
          equal($('label[for=edit-ipv4].error:visible').length, 0, Drupal.t('Error label not found for "IPv4"'));
        }
      },
      alphaNumeric: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-alpha-numeric].error:visible').length, 1, Drupal.t('Error label found for "Alpha Numeric"'));
          ...
          // Check for the error.
          equal($('label[for=edit-alpha-numeric].error:visible').length, 0, Drupal.t('Error label not found for "Alpha Numeric"'));
        }
      },
      alphaDash: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-alpha-dash].error:visible').length, 1, Drupal.t('Error label found for "Alpha Dash"'));
          ...
          // Check for the error.
          equal($('label[for=edit-alpha-dash].error:visible').length, 0, Drupal.t('Error label not found for "Alpha Dash"'));
        }
      },
      digit: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-digit].error:visible').length, 1, Drupal.t('Error label found for "Digit"'));
          ...
          // Check for the error.
          equal($('label[for=edit-digit].error:visible').length, 0, Drupal.t('Error label not found for "Digit"'));
        }
      },
      decimalLimited: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-decimal-limited].error:visible').length, 1, Drupal.t('Error label found for "Decimal (limited)"'));
          ...
          // Check for the error.
          equal($('label[for=edit-decimal-limited].error:visible').length, 0, Drupal.t('Error label not found for "Decimal (limited)"'));
        }
      },
      regex: function ($, Drupal, window, document, undefined) {
        return function() {
          ...
          // Check for the error.
          equal($('label[for=edit-regex].error:visible').length, 1, Drupal.t('Error label found for "Regex"'));
          ...
          // Check for the error.
          equal($('label[for=edit-regex].error:visible').length, 0, Drupal.t('Error label not found for "Regex"'));
        }
      }
    }
  };
